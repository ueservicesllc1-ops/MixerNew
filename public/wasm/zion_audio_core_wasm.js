...
async function ZionAudioCoreModule(moduleArg = {}) {
  var moduleRtn;
...
function findWasmBinary() {
  ...
  if (Module['locateFile']) {
    return locateFile('zion_audio_core_wasm.wasm');
  }

  // Use bundler-friendly `new URL(..., import.meta.url)` pattern; works in browsers too.
  return new URL('zion_audio_core_wasm.wasm', import.meta.url).href;
...
export default ZionAudioCoreModule;
